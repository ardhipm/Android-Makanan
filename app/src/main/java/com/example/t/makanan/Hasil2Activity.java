...
public class Hasil2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String karakteristik = getIntent().getExtras().getString("karakteristik");
        String awawl = getIntent().getExtras().getString("awal");
        String akhir = getIntent().getExtras().getString("akhir");
        try {
            JSONArray jsonArray = new JSONArray(makananActivity.getMakananByKarakteristik(karakteristik,awawl,akhir));
        ...
        final Adapter adapter = new Adapter(this, arrayMakanan);
